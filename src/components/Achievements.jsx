        ...
        <div className="bg-neutral-900/50 rounded-2xl p-6 border border-neutral-800">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-2xl font-bold text-white mb-2">SSC Completed</h3>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm">Top Score</span>
                <span className="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm">Academic Excellence</span>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="bg-neutral-900/50 rounded-2xl p-6 border border-neutral-800">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-2xl font-bold text-white mb-2">Diploma Graduated - College Topper</h3>
              <p className="text-neutral-400 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-yellow-500/20 text-yellow-400 rounded-full text-sm">🏆 College Topper</span>
                <span className="px-3 py-1 bg-purple-500/20 text-purple-400 rounded-full text-sm">CSE Department</span>
                <span className="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm">9.91 CGPA</span>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="bg-neutral-900/50 rounded-2xl p-6 border border-neutral-800">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-2xl font-bold text-white mb-2">1st Place - AminoVerse Hackathon</h3>
              <p className="text-neutral-400 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-yellow-500/20 text-yellow-400 rounded-full text-sm">🥇 1st Place</span>
                <span className="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm">Python Flask</span>
                <span className="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm">3Dmol.js</span>
                <span className="px-3 py-1 bg-purple-500/20 text-purple-400 rounded-full text-sm">Healthcare API's</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-neutral-900/50 rounded-2xl p-6 border border-neutral-800">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-orange-500/20 text-orange-400 rounded-full text-sm">AWS Certified</span>
                <span className="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm">Cloud Computing</span>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="bg-neutral-900/50 rounded-2xl p-6 border border-neutral-800">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-2xl font-bold text-white mb-2">Runner-up - VNRVJIET National Hackathon</h3>
              <p className="text-neutral-400 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-gray-500/20 text-gray-300 rounded-full text-sm">🥈 Runner-up</span>
                ...
                <span className="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm">Vite</span>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="bg-neutral-900/50 rounded-2xl p-6 border border-neutral-800">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-2xl font-bold text-white mb-2">Oracle Multicloud Architect Professional</h3>
              <p className="text-neutral-400 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-red-500/20 text-red-400 rounded-full text-sm">Oracle Certified</span>
                <span className="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm">Multicloud</span>
              </div>
            </div>
          </div>
        </div>
